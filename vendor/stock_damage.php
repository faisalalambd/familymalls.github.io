        ...
        <div class="row">
            ...
            <div class="col-12 col-md-12 col-lg-12">
                ...
                <div class="card">
                    ...
                    <!-- ############################## Form ############################## -->
                    <form action="damage_stock.php?id=<?php echo $id ?>" method="post">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-3 col-form-label"><strong>Damage Stock</strong></label>
                                <div class="col-sm-9">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-warning">DAMAGE</button>
                        </div>
