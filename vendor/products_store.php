...
$sql = "INSERT INTO products (image, name, price, offer, category,stock, details, available_for, materialandcare, product_thumb_1, product_thumb_2, product_thumb_3) VALUES ('$filename', '$name', '$price', '$offer', '$category','$stock', '$details','$available_for', '$materialandcare', '$filename1', '$filename2', '$filename3')";
